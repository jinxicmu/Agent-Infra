...
**The Sage 41s workflow update supports first-frame I2V and first/last-frame FL2V.** See the [complete client integration guide](API_CLIENT_GUIDE.md), [中文 API 示例](API_USAGE_H3.md) and [workflow changes](H3_WORKFLOW_UPDATE.md).
